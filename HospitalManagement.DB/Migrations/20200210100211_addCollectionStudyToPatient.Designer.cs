...
namespace HospitalManagement.DB.Migrations
{
    ...
    [Migration("20200210100211_addCollectionStudyToPatient")]
    partial class addCollectionStudyToPatient
    {
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DoctorId = 1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2020, 2, 10, 15, 32, 10, 666, DateTimeKind.Local).AddTicks(8084),
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Study", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DoctorId = 2,
                            EstimatedEndTime = new DateTime(2020, 2, 10, 15, 32, 10, 669, DateTimeKind.Local).AddTicks(6258),
                            PatientId = 1,
                            PlannedStartTime = new DateTime(2020, 2, 10, 15, 32, 10, 669, DateTimeKind.Local).AddTicks(6254),
                            StudyStatusId = 1
                        },
                        new
                        {
                            ...
                            Descriptions = "Initial check up",
                            DoctorId = 2,
                            EstimatedEndTime = new DateTime(2020, 2, 10, 15, 32, 10, 669, DateTimeKind.Local).AddTicks(7602),
                            PatientId = 2,
                            PlannedStartTime = new DateTime(2020, 2, 10, 15, 32, 10, 669, DateTimeKind.Local).AddTicks(7599),
                            StudyStatusId = 2
                        },
                        new
                        {
                            ...
                            Descriptions = "Initial check up",
                            DoctorId = 1,
                            EstimatedEndTime = new DateTime(2020, 2, 10, 15, 32, 10, 669, DateTimeKind.Local).AddTicks(7627),
                            PatientId = 3,
                            PlannedStartTime = new DateTime(2020, 2, 10, 15, 32, 10, 669, DateTimeKind.Local).AddTicks(7626),
                            StudyStatusId = 2
                        });
                });
