...
namespace HospitalManagement.DB.Migrations
{
    ...
    [Migration("20200206112748_updateSeed")]
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DoctorId = 1,
                            CreatedById = 1,
                            CreatedOn = new DateTime(2020, 2, 6, 16, 57, 47, 482, DateTimeKind.Local).AddTicks(3908),
            ...
            modelBuilder.Entity("HospitalManagement.Domain.Entities.Study", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DoctorId = 2,
                            EstimatedEndTime = new DateTime(2020, 2, 6, 16, 57, 47, 485, DateTimeKind.Local).AddTicks(1384),
                            PatientId = 1,
                            PlannedStartTime = new DateTime(2020, 2, 6, 16, 57, 47, 485, DateTimeKind.Local).AddTicks(1377),
                            StudyStatusId = 1
                        },
                        new
                        {
                            ...
                            Descriptions = "Initial check up",
                            DoctorId = 2,
                            EstimatedEndTime = new DateTime(2020, 2, 6, 16, 57, 47, 485, DateTimeKind.Local).AddTicks(2598),
                            PatientId = 2,
                            PlannedStartTime = new DateTime(2020, 2, 6, 16, 57, 47, 485, DateTimeKind.Local).AddTicks(2596),
                            StudyStatusId = 2
                        },
                        new
                        {
                            ...
                            Descriptions = "Initial check up",
                            DoctorId = 1,
                            EstimatedEndTime = new DateTime(2020, 2, 6, 16, 57, 47, 485, DateTimeKind.Local).AddTicks(2619),
                            PatientId = 3,
                            PlannedStartTime = new DateTime(2020, 2, 6, 16, 57, 47, 485, DateTimeKind.Local).AddTicks(2619),
                            StudyStatusId = 2
                        });
                });
